...
def register(request):
    if request.method=='POST':
        ...
        data=Userregister(name=name1,email=email1,password=password1,address=address1,phone=phone1)
...
RAZOR_KEY_ID = 'rzp_test_QCKFKwR1ig8d5d'
RAZOR_KEY_SECRET = 'poGigM8P3tJgjB8CGfiKa4FU'
